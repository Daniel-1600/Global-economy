...
export default function Footer() {
  ...
  const socialLinks = [
    {
      name: 'GitHub',
      href: 'https://github.com/Daniel-1600/Global-economy',
      icon: (
  ...
  return (
    <footer className="relative bg-black border-t border-blue-500/10">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-8 mb-12">
          ...
          <div className="col-span-2">
            ...
            <p className="text-gray-400 text-sm mb-4 max-w-xs">
              Real-time global economic data and AI-powered insights at your
              fingertips.
            </p>
        ...
        {/* Newsletter Section */}
        <div className="border-t border-blue-500/10 pt-8 mb-8">
          <div className="flex flex-col md:flex-row justify-between items-center gap-6">
            ...
            <div className="flex gap-2 w-full md:w-auto">
              <input
                ...
                className="flex-1 md:w-64 px-4 py-2 bg-gray-900/50 border border-blue-500/30 rounded-lg text-white placeholder-gray-500 focus:outline-none focus:border-blue-500 transition-colors text-sm"
              />
              <motion.button
                whileHover={{ scale: 1.05 }}
                whileTap={{ scale: 0.95 }}
                className="px-6 py-2 bg-blue-600 text-white font-medium rounded-lg hover:bg-blue-500 transition-all text-sm"
              >
                Subscribe
              </motion.button>
            </div>
        ...
        <div className="border-t border-blue-500/10 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
          <p className="text-gray-400 text-sm">
            © {currentYear} Economy Explorer. All rights reserved.
          </p>
